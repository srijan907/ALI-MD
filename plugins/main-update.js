...
cmd({
    ...
    try {
        await reply("🔍 Checking for RABBIT-XMD updates...");

        // Fetch the latest commit hash from GitHub
        const { data: commitData } = await axios.get("https://api.github.com/repos/srijan907/ALI-MD/commits/main");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your RABBIT-XMD bot is already up-to-date!");
        }
        ...
        const { data: zipData } = await axios.get("https://github.com/srijan907/ALI-MD/archive/main.zip", { responseType: "arraybuffer" });
